...
Xp=31;%number of x surfaces
Yp=26;%number of y surfaces
...
for k=1:ItMAX
            ...
            [a,an,as,aw,ae,b]=CoeffCal(Tc,dxc,dyc,dy,dx,Qg,BE,BW,BN,BS,hbE,hbW,hbN,hbS,TinfE,TinfW,TinfN,TinfS,TbE,TbW,TbN,TbS,QbE,QbW,QbN,QbS,kn,ks,ke,kw,Ux,Uy,ConvectionScheme,Rho,UxinW,UxinE,UyinS,UyinN,TWin,TNin,TSin,TEin,Cp);
